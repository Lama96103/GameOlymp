...
<body>
    ...
    <div class="jumbotron">
        ...
        <p class="lead">Welcome to the Game Olymp. If you have login data, then go for it. If not contact me.</p>
    </div>
    ...
    <div class="container-fluid" style="background-color: white; margin-top: 10px">
        <form action="/php/login/login.php" method="post" >
            ...
            <div class="container form-group">
                <button type="submit" class="btn btn-primary col align-self-center" >Login</button>
            </div>
     ...
     <div class="container-fluid" style="background-color: white; margin-top: 10px">
        <form action="/site/signup.php" >
            <div class="container form-group">
                <button type="submit" class="btn btn-primary col align-self-center" >Signup</button>
            </div>
